...
(function() {
    ...
    var defaults = {
        ...
        hideBarsDelay: 6000,
        isM:/AppleWebKit.*Mobile.*/i.test(navigator.userAgent.toLowerCase()),
        useLeft: false,
    ...
    Plugin.prototype.build = function(index) {
        ...
        if (_this.s.hideBarsDelay > 0 && !_this.s.isM) {
...
(function() {
    ...
    Thumbnail.prototype.toogle = function() {
        ...
        if (_this.core.s.toogleThumb) {
           ...
           // _this.core.$outer.append('<button type="button" style="right: 10px" aria-label="Toggle thumbnails" class="lg-close-thumb lg-close lg-icon"></button>')
            var tpl='<button type="button"  aria-label="Toggle thumbnails" class="js-lg-toogle-thumb lg-toogle-thumb lg-icon"></button>'
            _this.$thumbOuter.append(tpl);
            _this.core.$outer.find('.js-lg-toogle-thumb').on('click.lg', function() {
                //lg-thumb-open lg-hide-items
                _this.core.$outer.toggleClass('lg-thumb-open');
                if(_this.core.s.isM){
                    if(_this.core.$outer.hasClass('lg-thumb-open')){
                        _this.core.$outer.removeClass('lg-hide-items')
                    }else {
                        _this.core.$outer.addClass('lg-hide-items')
                    }
                }
